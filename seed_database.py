...
for parent in parent_data:
    ...
    fname, lname, email, password = (parent["fname"], parent["lname"], parent["email"], parent["password"])
    #release_date = datetime.strptime(movie["release_date"],"%Y-%m-%d") #"2020-05-22"

    new_parent = crud.create_parent(fname, lname, email, password) #Need non-nullable fields as args
